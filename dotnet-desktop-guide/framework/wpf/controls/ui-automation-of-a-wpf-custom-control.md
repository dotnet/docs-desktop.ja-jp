...
- [UI オートメーションの概要](/dotnet/framework/ui-automation/ui-automation-overview)
- [サーバー側 UI オートメーション プロバイダーの実装](/dotnet/framework/ui-automation/server-side-ui-automation-provider-implementation)
