...
## <a name="example"></a>例  
 ...
 このコード例を使用するには、アプリケーションをコンパイルして実行し、コントロールの [ **中央 (Spring)** ] をクリックして <xref:System.Windows.Forms.StatusStrip> プロパティの値を切り替え <xref:System.Windows.Forms.ToolStripStatusLabel.Spring%2A> ます。  
