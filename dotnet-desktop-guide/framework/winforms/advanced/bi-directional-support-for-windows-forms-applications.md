...
|<xref:System.Windows.Forms.OpenFileDialog>|右から左に記述するオペレーティングシステムでは、 <xref:System.Windows.Forms.Control.RightToLeft> ダイアログをローカライズするために、含んでいるフォームのプロパティを設定します。 <xref:System.Windows.Forms.RightToLeft.Yes?displayProperty=nameWithType> |効果なし|いいえ|
...
- [ASP.NET Web アプリケーションに対する双方向サポート](/previous-versions/aspnet/6eedwbtt(v=vs.100))
